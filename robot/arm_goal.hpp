...
public:
  ...
  Goal(const Eigen::VectorXd& times, const Eigen::VectorXd& positions)
    : times_(times), positions_(toMatrix(positions)),
      velocities_(nanWithZeroRight(positions.size(), 1)),
      accelerations_(nanWithZeroRight(positions.size(), 1))
  {}

  // Single waypoints, no time
  Goal(const Eigen::VectorXd& positions, const Eigen::VectorXd& velocities, const Eigen::VectorXd& accelerations)
    : positions_(toMatrix(positions)), velocities_(toMatrix(velocities)), accelerations_(toMatrix(accelerations))
  {}

  // Single waypoints
  Goal(const Eigen::VectorXd& times, const Eigen::VectorXd& positions, const Eigen::VectorXd& velocities, const Eigen::VectorXd& accelerations)
    : times_(times), positions_(toMatrix(positions)), velocities_(toMatrix(velocities)), accelerations_(toMatrix(accelerations))
  {}

  // Single waypoints + aux state, no time
  Goal(const Eigen::VectorXd& positions, const Eigen::VectorXd& velocities, const Eigen::VectorXd& accelerations, const Eigen::VectorXd& aux)
    : positions_(toMatrix(positions)), velocities_(toMatrix(velocities)), accelerations_(toMatrix(accelerations)), aux_(aux)
  {}

  // Single waypoints + aux state
  Goal(const Eigen::VectorXd& times, const Eigen::VectorXd& positions, const Eigen::VectorXd& velocities, const Eigen::VectorXd& accelerations, const Eigen::VectorXd& aux)
    : times_(times), positions_(toMatrix(positions)), velocities_(toMatrix(velocities)), accelerations_(toMatrix(accelerations)), aux_(aux)
  {}
  ...
  Goal(const Eigen::VectorXd& times, const Eigen::MatrixXd& positions)
    : times_(times), positions_(positions),
      velocities_(nanWithZeroRight(positions.rows(), positions.cols())),
      accelerations_(nanWithZeroRight(positions.rows(), positions.cols()))
  {}

  // Multiple waypoints, no time
  Goal(const Eigen::MatrixXd& positions, const Eigen::MatrixXd& velocities, const Eigen::MatrixXd& accelerations)
    : positions_(positions), velocities_(velocities), accelerations_(accelerations)
  {}

  // Multiple waypoints
  Goal(const Eigen::VectorXd& times, const Eigen::MatrixXd& positions, const Eigen::MatrixXd& velocities, const Eigen::MatrixXd& accelerations)
    : times_(times), positions_(positions), velocities_(velocities), accelerations_(accelerations)
  {}

  // Multiple waypoints + aux state, no time
  Goal(const Eigen::MatrixXd& positions, const Eigen::MatrixXd& velocities, const Eigen::MatrixXd& accelerations, const Eigen::MatrixXd& aux)
    : positions_(positions), velocities_(velocities), accelerations_(accelerations), aux_(aux)
  {}
  ...
  Goal(const Eigen::VectorXd& times, const Eigen::MatrixXd& positions, const Eigen::MatrixXd& velocities, const Eigen::MatrixXd& accelerations, const Eigen::MatrixXd& aux)
    : times_(times), positions_(positions), velocities_(velocities), accelerations_(accelerations), aux_(aux)
  {}
